...
namespace CritterHeroes.Web.Data.Configurations
{
    public class BreedConfiguration : EntityTypeConfiguration<Breed>
    {
        public BreedConfiguration()
        {
            ...
            Property(x => x.BreedName).IsRequired().HasMaxLength(50).HasColumnAnnotation(IndexAnnotation.AnnotationName, new IndexAnnotation(new IndexAttribute("SpeciesBreed", 2))); // BreedName is not unique
