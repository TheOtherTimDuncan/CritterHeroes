...
namespace CH.Test.RescueGroups.MappingTests
{
    ...
    public class BreedSourceTests : BaseTest
    {
        ...
        {
            new BreedSourceStorage(new RescueGroupsConfiguration(), null).ObjectType.Should().Be("animalBreeds");
        }
        ...
        public void ConvertsJsonResultToModel()
        {
            ...
            IEnumerable<BreedSource> animalBreeds = new BreedSourceStorage(new RescueGroupsConfiguration(), null).FromStorage(data.Properties());
